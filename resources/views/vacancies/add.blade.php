...
<div><h1 class="page-title">Post New Vacancy</h1></div><br/><br/>
  <form action="{{url('/vacancy/add')}}" method="post" class="forms-sample">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="company"placeholder="Type age limit eg:22-30" />
    </div>
    <div class="form-group">
    <label class=col>Needed Employee</label>
        <input type="number" min="1" placeholder="select needed No of employee" class="form-control">
    </div>
    <div class="form-group">

    ...
    <div class="container-scroller">
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav">
          <li class="nav-item nav-profile">
            <a href="#" class="nav-link">
              <div class="nav-profile-image">
                <img src="{{ asset('images/admin-girl.png') }}" alt="profile" width="80px" height="80px" />
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="layouts/login.php" aria-expanded="false" aria-controls="ui-basic">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item">
                  <a class="nav-link" href="pages/ui-features/buttons.html">Button</a>
                </li>
                <li class="nav-item">
